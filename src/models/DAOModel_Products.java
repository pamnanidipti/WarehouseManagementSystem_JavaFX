...
public class DAOModel_Products {
    ...
    public void createProductsTable() {
        try {
            ...
            String sql = "CREATE TABLE product (productId int NOT NULL AUTO_INCREMENT, productName VARCHAR(255), productStatus VARCHAR(255),productDescription VARCHAR(255), PRIMARY KEY(productId))";
